...
# fisotope
> JQuery Masonry / Isotope implemented with famo.us.

[![Build Status](https://travis-ci.org/naman34/fisotope.svg?branch=master)](https://travis-ci.org/naman34/fisotope) [![Dependency Status](https://david-dm.org/naman34/fisotope.svg)](https://david-dm.org/naman34/fisotope) [![devDependency Status](https://david-dm.org/naman34/fisotope/dev-status.svg)](https://david-dm.org/naman34/fisotope#info=devDependencies)
...
## Future
Everything will be easier in the future. It should work without any configuration soon.
